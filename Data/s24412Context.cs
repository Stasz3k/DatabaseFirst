...
public partial class s24412Context : DbContext
{
    public s24412Context()
    {
    }

    public s24412Context(DbContextOptions<s24412Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=(localdb)\\RestAPI;Database=RestAPI_DB;Trusted_Connection=True;");
